...
#define LCD_CON      PORTC // CON 포트는 포트 C와 연결됨을 정의
#define LCD_DATA     PORTA // DATA 포트는 포트 A와 연결됨을 정의
#define LCD_DATA_DIR DDRA // DATA 포트의 출력 방향 설정 매크로를 정의
#define LCD_DATA_IN  PINA // DATA 포트의 입력 방향 설정 매크로를 정의
#define LCD_RS   0 // RS 신호의 비트 번호 정의
#define LCD_RW   1 // RW 신호의 비트 번호 정의
#define LCD_E    2 // E 신호의 비트 번호 정의

unsigned char LCD_rCommand(void) { // 텍스트 LCD로 부터 상태(명령)를 읽는 함수
